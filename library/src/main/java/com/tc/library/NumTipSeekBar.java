...
//    }
//
//    private void judgePosition(float x, boolean isTouchMove) {
//        float start = getPaddingLeft();
//        int progress = mSelectProgress;
//        if (x >= start) {
//            double result = (x - start) / mViewWidth * (float) mMaxProgress;
...
//        if (progress != mSelectProgress) {
//            //发生变化才通知view重新绘制
//            setSelectProgress(progress, false, isTouchMove);
//        }
//
//    }
//
...
//    private void initValues(int width, int height) {
//        //view内容区域的高宽，不含边框。不是整体view的高宽
//        float circleButtonWidth = 0;
//        if (mIsShowButton) {
//            if (mIsShowCircleAperture) {
//                circleButtonWidth = mCircleApertureWidth * 2 + mCircleButtonRadius * 2;
//            } else {
//                circleButtonWidth = +mCircleButtonRadius * 2;
//            }
//        }
//        mViewWidth = (int) (width - mBorderSize * 2 - circleButtonWidth - getPaddingLeft() - getPaddingRight());
//        mViewHeight = (int) (height - mBorderSize * 2);
//
//        int leftPadding = (int) (mBorderSize + circleButtonWidth / 2);
//        int topPadding = (int) mBorderSize;
//
//        if (mTickBarHeight > mViewHeight) {
//            //如果刻度条的高度大于view本身的高度的1/2，则显示不完整，所以处理下。
...
//     */
//    public void setSelectProgress(int selectProgress) {
//        this.setSelectProgress(selectProgress, true, false);
//    }
//
//    /**
//     * 设置当前选中的值
...
//     */
//    public void setSelectProgress(int selectProgress, boolean isNotifyListener) {
//        this.setSelectProgress(selectProgress, isNotifyListener, false);
//    }
//
//    /**
//     * 设置当前选中的值
...
//     * @param selectProgress   进度
//     * @param isNotifyListener 是否通知progresschangelistener
//     * @param isTouchMove      是否手指拖动触发更新，此时需要刷新界面
//     */
//    public void setSelectProgress(int selectProgress, boolean isNotifyListener, boolean isTouchMove) {
////        LogUtil.d(TAG, "isTouchMove：" + false + "  mIsTouching:" + mIsTouching);
//        if (mIsTouching && !isTouchMove) {
////            LogUtil.d(TAG, "is touching view ,don't invalidate. ");
//            return;
//        }
//        getSelectProgressValue(selectProgress);
////        Log.i(TAG, "mSelectProgress: " + mSelectProgress + "  mMaxProgress: " +
